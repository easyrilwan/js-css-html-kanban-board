...
let tasks = [
  {
    id: 0,
    title: "Fix the submit button",
    description: "The submit button has stopped working since last release.",
  },
  {
    id: 1,
...
function addColour(column) {
  ...
  switch (column) {
    ...
    case "done":
      ...
      break;
    case "discard":
      colour = "rgb(167, 65, 28)";
      break;

    default:
      colour = "rgb(232, 232, 232)";
  }
  return colour;
}

function addTasks() {
  //Advanced: You can pass through the whole object if you wish
...
function dragDrop() {
  ...
  elementBeingDragged.firstChild.style.backgroundColor = addColour(columnId);
